...
export class MoltenDB {
  ...
  constructor(dbName = 'moltendb', options: MoltenDBOptions = {}) {
    ...
    async init(): Promise<void> {
        ...
        return new Promise<void>((resolveInit) => {
    ...
    private async startAsLeader() {
        ...
        if (this.worker) this.worker.terminate(); // Clean slate if promoted
    ...
    async set(collection: string, key: string, value: Record<string, unknown>, options: { skipSync?: boolean } = {}): Promise<void> {
