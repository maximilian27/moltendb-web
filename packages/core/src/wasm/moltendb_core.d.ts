...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_4373: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4375: (a: number, b: number, c: number, d: number) => void;
