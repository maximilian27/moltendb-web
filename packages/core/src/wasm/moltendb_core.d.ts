...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_4086: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4098: (a: number, b: number, c: number, d: number) => void;
