...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_4328: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4341: (a: number, b: number, c: number, d: number) => void;
