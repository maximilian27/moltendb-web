...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_4493: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4499: (a: number, b: number, c: number, d: number) => void;
