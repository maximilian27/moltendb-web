...
export class WorkerDb {
    ...
    static create(db_name, encryption_key, write_mode, max_body_size, max_keys_per_request, in_memory) {
        ...
        const ret = wasm.workerdb_create(ptr0, len0, ptr1, len1, ptr2, len2, isLikeNone(max_body_size) ? Number.MAX_SAFE_INTEGER : (max_body_size) >>> 0, isLikeNone(max_keys_per_request) ? Number.MAX_SAFE_INTEGER : (max_keys_per_request) >>> 0, isLikeNone(in_memory) ? 0xFFFFFF : in_memory ? 1 : 0);
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_close_d00f4cb641f9db10: function(arg0) {
        ...
        __wbg_new_typed_1824d93f294193e5: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return __wasm_bindgen_func_elem_4375(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_4373);
            return addHeapObject(ret);
        },
...
function __wasm_bindgen_func_elem_4373(arg0, arg1, arg2) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.__wasm_bindgen_func_elem_4373(retptr, arg0, arg1, addHeapObject(arg2));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        if (r1) {
            throw takeObject(r0);
...
function __wasm_bindgen_func_elem_4375(arg0, arg1, arg2, arg3) {
    wasm.__wasm_bindgen_func_elem_4375(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}

const WorkerDbFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_workerdb_free(ptr, 1));
