...
export const __wasm_bindgen_func_elem_4165: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_4177: (a: number, b: number, c: number, d: number) => void;
