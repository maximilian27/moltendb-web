...
export const __wasm_bindgen_func_elem_4087: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_4099: (a: number, b: number, c: number, d: number) => void;
