...
export const __wasm_bindgen_func_elem_1888: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_1892: (a: number, b: number, c: number, d: number) => void;
