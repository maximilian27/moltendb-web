...
export const __wasm_bindgen_func_elem_4114: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_4120: (a: number, b: number, c: number, d: number) => void;
