...
export const __wasm_bindgen_func_elem_4298: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_4310: (a: number, b: number, c: number, d: number) => void;
